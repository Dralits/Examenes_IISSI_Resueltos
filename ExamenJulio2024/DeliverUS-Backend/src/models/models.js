...
import loadPerformancesModel from './Performances.js'
...
const Performances = loadPerformancesModel(sequelizeSession, Sequelize.DataTypes)

const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Performances }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Performances, sequelizeSession }
