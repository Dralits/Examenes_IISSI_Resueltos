...
import { getAll, remove, switchPin } from '../../api/RestaurantEndpoints'
  ...
  const renderRestaurant = ({ item }) => {
    return (
      ...
      >
        ...
        <View>
          <TextSemiBold>Shipping: <TextSemiBold textStyle={{ color: GlobalStyles.brandPrimary }}>{item.shippingCosts.toFixed(2)}€{"\n\n"}</TextSemiBold></TextSemiBold>
  ...
  return (
    ...
    <PinModal
      ...
      onConfirm={() => pinRestaurant(restaurantToBePinned)}>
        <TextRegular>The restaurant is going to be Pinned</TextRegular>
    </PinModal>
