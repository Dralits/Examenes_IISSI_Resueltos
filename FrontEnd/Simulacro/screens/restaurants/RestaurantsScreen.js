...
export default function RestaurantsScreen ({ navigation, route }) {
  ...
  const switchPinRestaurant = async (restaurant) => {
    try{
  ...
  return (
    ...
    onConfirm={() => switchPinRestaurant(restaurantToBePinned)}>
        <TextRegular>This restaurant is going to get pinned</TextRegular>
    </PinModal>
    </>
  )
}
